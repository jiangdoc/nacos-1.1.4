...
class ServiceList extends React.Component {
  ...
  render() {
    ...
    return (
      < div
    className = "main-container service-management" >
      < Loading
    shape = "flower"
    style = {
    {
  ...
  <
    ...
    className = "page-title" >
      < span
    className = "title-item" > {serviceList} < /span>
      < span
  ...
  <
    Column
    title = {locale.columnServiceName}
    dataIndex = "name" / >
      < Column
    title = {locale.groupName}
    dataIndex = "groupName" / >
      < Column
    title = {locale.columnClusterCount}
    dataIndex = "clusterCount" / >
      < Column
    title = {locale.columnIpCount}
    dataIndex = "ipCount" / >
      < Column
    ...
    dataIndex = "healthyInstanceCount"
      / >
      < Column
    title = {locale.columnTriggerFlag}
